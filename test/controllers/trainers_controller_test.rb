...
class TrainersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create trainer" do
    assert_difference('Trainer.count') do
      post trainers_url, params: { trainer: { Address: @trainer.Address, Current_weight: @trainer.Current_weight, Email: @trainer.Email, Gender: @trainer.Gender, Height: @trainer.Height, Name: @trainer.Name } }
    end
  ...
  test "should update trainer" do
    patch trainer_url(@trainer), params: { trainer: { Address: @trainer.Address, Current_weight: @trainer.Current_weight, Email: @trainer.Email, Gender: @trainer.Gender, Height: @trainer.Height, Name: @trainer.Name } }
